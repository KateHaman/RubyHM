...
array_min = array.min
array.each_index { |i| array[i] = array_min if array[i].positive? }
puts '-------------------------------------------------'
...
array = [-20, 5, -3, 0, 11, -22]
array_max = array.max
array.each_index { |i| array[i] = array_max if array[i].negative? }
puts '-------------------------------------------------'
